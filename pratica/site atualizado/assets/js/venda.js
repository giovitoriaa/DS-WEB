...
function atualizaProduto(){
    ...
    //Cria o cabeçalho dos produtos
        ...
        adicionaQuantidade.innerHTML= "<i onclick= 'quantidadeProduto("+produto.id+",-1)' class='fa-solid fa-minus'></i>" + produto.quantidade + 
        ...
        adicionaExcluir.innerHTML = "<i onclick= 'excluirProduto("+produto.id+",-1)' class='fa-solid fa-trash'></i>";
...
function quantidadeProduto(id, quantidade){
    if (produtos [id].quantidade + quantidade >= 1){ //Valida menor do q 1
        if(produtos[id].quantidade + quantidade <= produtos[id].estoque){ // Valida o limite
...
function atualizaCarrinho(){
    ...
    adicionaTotal.textContent = "Total";
    ...
    adicionaBotao.textContent = "resgistar venda"
